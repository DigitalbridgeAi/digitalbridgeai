        ...
        <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-phone_code" name="phone_code"  placeholder="{{ __('Enter phone code') }}" value="{{ optional($gs)->phone_code }}" required>
              </div>    
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-latitude" name="latitude"  placeholder="{{ __('Enter Latitude') }}" value="{{ optional($gs)->latitude }}" required>
              </div>    
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-longitude" name="longitude"  placeholder="{{ __('Enter Longitude') }}" value="{{ optional($gs)->longitude }}" required>
              </div>    
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-title" name="title"  placeholder="{{ __('Enter Website Title') }}" value="{{ optional($gs)->title }}" required>
              </div>    
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-disqus" name="disqus"  placeholder="{{ __('Disqus Website Short Name') }}" value="{{ optional($gs)->disqus }}" required>
              </div>
            </div>
